      ...
      >
        ...
        <div className="flex flex-col items-center gap-4 mt-auto">
          <Button
            href="/"
            type="button"
            className="bg-[#ffffff] focus:bg-[#383b4533]  px-6 py-2 rounded-md font-medium text-black"
          >
            Login
          ...
          <Button
            href="/"
            type="button"
            className="bg-[#ffffff] focus:bg-[#383b4533] px-4 py-2 rounded-md font-medium text-black"
          >
            Sign Up
            <SiGnuprivacyguard className="ml-2" />
          </Button>
        </div>
      </nav>
    </>
