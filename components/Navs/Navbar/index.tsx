...
const Navbar = () => {
  ...
  return (
    <header className="w-full shadow-lg bg-transparent">
      <nav
        className={cn(
          "max-[500px]:py-2 sm:px-[5%] px-[4%] h-[12vh] flex justify-between items-center transition-colors duration-500 max-w-[1440px] mx-auto",
          scrollHeight > 200
...
// // Fixed Navbar and backdrop-blur 
...
//   return (
//     <header className="w-full fixed top-0 z-50 backdrop-blur-lg bg-white/50 shadow-lg ">
//       <nav
//         className={cn(
//           "sm:px-[5%] px-[4%] h-[12vh] flex justify-between items-center max-w-[1440px] mx-auto"
//           ,{
//             "bg-white/60": scrollHeight > 800 && scrollHeight < 4300,
//           }
//         )}
