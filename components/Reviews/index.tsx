...
//       <p>{content}</p>
//     </div>
//     <div className="rating mt-2 text-amber-300">
//       {"★".repeat(rating)}
//       {"☆".repeat(5 - rating)}
//     </div>
//   </motion.div>
...
//         {/* Cards section with flex row layout */}
//         <div className="flex flex-row flex-wrap gap-8 justify-center text-[#c2bfbf] ribbon-container">
...
//           <button className="p-3 rounded-full bg-gray-600 hover:bg-gray-800">
//             <FaArrowLeft size={24} />
//           </button>
//           <button className="p-3 rounded-full bg-gray-600 hover:bg-gray-800">
...
// }) => (
//   <motion.div
//     className="card flex flex-col mr-4 p-5 border border-gray-200 rounded-md shadow-md relative mt-2"
//     style={{ width: "270px", minHeight: "198px" }}
//     whileHover={{ scale: 1.05, transition: { duration: 0.3 } }}
//     initial={{ opacity: 0, y: 50 }}
//     animate={{ opacity: 1, y: 0 }}
...
//             className="flex flex-row overflow-x-auto gap-8 scrollbar-hide"
...
//             <button
//               onClick={scrollLeft}
//               className="p-3 rounded-full bg-gray-600 hover:bg-gray-800"
//             >
//               <FaArrowLeft size={24} />
//             </button>
//             <button
    ...
    <div className="w-full min-h-screen bg-[#FAFAFA]">
      <div className="max-w-[1440px] mx-auto sm:px-[5%] px-[4%] mt-4">
        ...
        <div className="flex flex-col justify-center items-center mt-8">
          ...
          <div className="relative flex items-center mt-4">
            <input
              className="w-full p-4 pr-40 font-medium placeholder-opacity-100 border rounded-md focus:outline-none bg-gray-100"
              type="text"
              placeholder="contact@petadoption.com"
            />
            <Button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-[#807500] hover:bg-[#47431c86] focus:bg-[#807500] text-white text-sm font-medium leading-snug text-center rounded-full px-4 py-2 flex items-center">
